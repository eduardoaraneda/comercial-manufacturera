-- Tabla: CotizacionDetalle. Ejecutar despues de los archivos anteriores.
SET ANSI_NULLS ON;
...
CREATE TABLE CotizacionDetalle (
    ...
    CONSTRAINT FK_CotizacionDetalle_Cotizacion FOREIGN KEY (CotizacionId) REFERENCES Cotizacion(CotizacionId),
    CONSTRAINT FK_CotizacionDetalle_Producto FOREIGN KEY (ProductoId) REFERENCES Producto(ProductoId),
...
CREATE INDEX IX_CotizacionDetalle_Producto ON CotizacionDetalle(ProductoId);
GO
