-- Tabla: Cotizacion. Ejecutar despues de los archivos anteriores.
SET ANSI_NULLS ON;
...
CREATE TABLE Cotizacion (
    ...
    CONSTRAINT FK_Cotizacion_Cliente FOREIGN KEY (ClienteId) REFERENCES Cliente(ClienteId),
    CONSTRAINT FK_Cotizacion_Bodega FOREIGN KEY (BodegaId) REFERENCES Bodega(BodegaId),
    CONSTRAINT FK_Cotizacion_Usuario FOREIGN KEY (CreadaPorUsuarioId) REFERENCES Usuario(UsuarioId),
...
CREATE INDEX IX_Cotizacion_Cliente_Fecha ON Cotizacion(ClienteId, CreadaEn);
GO

CREATE INDEX IX_Cotizacion_Bodega ON Cotizacion(BodegaId);
GO

CREATE INDEX IX_Cotizacion_Usuario ON Cotizacion(CreadaPorUsuarioId);
GO

CREATE INDEX IX_Cotizacion_Estado_Vencimiento ON Cotizacion(Estado, VenceEn);
GO
